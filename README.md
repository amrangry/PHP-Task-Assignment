...
<p>
PHP-Task-Assignment is distributed under the MIT License.  
For more information, see the <a href="https://github.com/amrangry/PHP-Task-Assignment/blob/master/LICENSE" target="_blank">LICENSE</a> file.  
